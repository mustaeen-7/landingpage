...
const clMenu = document.querySelector(".fa-solid.fa-x");
...
gsap.from(".wrapper div", { duration: 1, opacity: 0, delay: 1, stagger: 0.5 });
gsap.from(".img img", { duration: 1, x: "-100vw", ease: "ease" });
gsap.from(".side-one .txt", {
  duration: 1,
  delay: 1,
  y: "-100vh",
  ease: "power2.in",
...
gsap.fromTo(
  ".big-title",
  { opacity: 0, scale: 0, rotation: 400 },
